...
import './_header-info.scss'
import './_header-navigation.scss'
import Modal from '../modal/modal'
import LogoIcon from '../../assets/img/icon/site-logo.svg'
import { useState } from 'react'

function Header () {

  const [modal, setModal] = useState('search-modal')

  function openModal () {
    setModal('search-modal search-modal--open')
  }
    ...
    <>
      <header className="site-header">
        <section className="site-header__top header-info">
          <h2 className="visually-hidden">Aur contacts</h2>
        ...
        <section className="site-header__bottom header-navigation">
          ...
          <div className="header-navigation__container container">
            <a className="header-navigation__logo-link" href="index.html">
              <img className="header-navigation__logo" src={LogoIcon} alt="site logo" width={104} height={49} />
            </a>
            <div className="header-navigation__links">
              <nav className="header-navigation__nav header-nav">
                <ul className="header-nav__list">
                  <li className="header-nav__item"><a className="header-nav__link" href="index.html">Home</a></li>
                  <li className="header-nav__item"><a className="header-nav__link header-nav__link--active" href="books.html">Books</a></li>
                  <li className="header-nav__item"><a className="header-nav__link" href="/#">Settings</a></li>
                </ul>
              </nav>
              <button onClick={openModal} className="header-navigation__links-search js-search-button" type="button">
              </button>
